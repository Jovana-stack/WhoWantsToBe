...
public class fiftyfifty extends state implements statemethods{
	...
	public fiftyfifty(Game game) {
		super(game);
                this.r = new Random();
                // this makes the fonts the are need for text
	...
	public void update() {
        ...
        public void setQuestion(Question q) {
            // this gets the options for the fiftyfifty one correct and one wrong  
		this.question = q;
                this.correctAns = q.getCorrectAnswer();
                double randInt;
                randInt = r.nextInt(4);
                
                while (randInt == correctAns){ // this makes sure the wrong ans is wrong 
                    randInt = r.nextInt(4);
                }
	...
	@Override
	public void draw(Graphics g) { // this draws the gui
            ...
            if(correctAns < wrongAns){ // this makes sure that the correct ans and wrong ans are dispayed in the right order 
                ...
                // option0
                // if option0 is beaning hoverd over it glows 
                g2.setColor(Color.WHITE);
                if(this.option0Glow){
                    g2.setColor(Color.YELLOW);
                }
		...
		// option1
                // if option1 is beaning hoverd over it glows 
                g2.setColor(Color.WHITE);
                if(this.option1Glow){
                    g2.setColor(Color.YELLOW);
                }		                
